...
extern Fl_Choice *mnu_RTTY_filter_quality;
extern Fl_Button *btn_optimum_rtty_bw;
extern Fl_Choice *mnuRTTYAFCSpeed;
extern Fl_Choice *mnu_kahn_demod;
...
extern Fl_Group *AudioFile;
extern Fl_Round_Button *btnAudioIO[5];
extern Fl_Input2 *inpFileName;
